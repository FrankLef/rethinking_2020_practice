...
Several helper functions are used to simplify the code below.  They are
not in a packaged and are found in the `helpers` folder.

```{r}
# source(here::here("helpers", "gt_posterior.R"))
```
