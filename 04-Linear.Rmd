...
inv.scale <- function(x, 
  ...
  round(center + x * scale, digits = digits)
}
```
...
# It removes the duplicate point valaue that repeat itself when putting
# intervals in long format.
