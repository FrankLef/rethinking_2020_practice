...
```{r}
preds <- list(n = 1000L)
preds$data <- eflINLA::predict_inla(args = i04M07ctr_args, n = preds$n, 
                                    newdata = newdata$data, dep_var = "height")
...
different however.  This aspect was not investigasted in this project as
additive models are not the main scope of the book.
...
data04H03 <- Howell1 %>%
  mutate(weight_c = scale(weight, center = TRUE, scale = FALSE))
rm("Howell1")
stopifnot(all.equal(dim(data04H03), c(544L, 5L)))
