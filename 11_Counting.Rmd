...
```{r}
a_file <- here::here("fits", "m11M07a.qs")
m11M07a <- qread(a_file)
# m11M07a <- ulam(
#   data = dataChimp,
#   flist = alist(
...
```{r}
a_file <- here::here("fits", "m11M07b.qs")
m11M07b <- qread(a_file)
# m11M07b <- quap(
#   dataChimp,
#   flist = alist(
#     pulled_left ~ dbinom(1, p),
...
```{r}
a_file <- here::here("fits", "m11M07c.qs")
m11M07c <- qread(a_file)
...
```{r}
a_file <- here::here("fits", "m11M07d.qs")
m11M07d <- qread(a_file)
# m11M07d <- quap(
#   dataChimp,
#   flist = alist(
#     pulled_left ~ dbinom(1, p),
...
```{r}
a_file <- here::here("fits", "b11M08a.qs")
b11M08a <- qread(a_file)
...
```{r}
a_file <- here::here("fits", "b11M08b.qs")
b11M08b <- qread(a_file)
# dh <- dataKline %>%
...
```{r}
a_file <- here::here("fits", "b11H01a.qs")
b11H01a <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "b11H01b.qs")
b11H01b <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "b11H01c.qs")
b11H01c <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "m11H02a.qs")
m11H02a <- qread(file = a_file)
# m11H02a <- quap(
#   dataEagles,
#   flist = alist(
#     y ~ dbinom(n, p),
...
```{r}
a_file <- here::here("fits", "b11H02a.qs")
b11H02a <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "i11H02a.qs")
i11H02a <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "b11H02b.qs")
b11H02b <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "m11H03a.qs")
m11H03a <- qread(file = a_file)
# m11H03a <- quap(
#   data = dataSalam,
#   flist = alist(
...
```{r}
a_file <- here::here("fits", "b11H03a.qs")
b11H03a <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "i11H03a.qs")
i11H03a <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "b11H03b.qs")
b11H03b <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "b11H03c.qs")
b11H03c <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "m11H04_g.qs")
m11H04_g <- qread(file = a_file)
# m11H04_g <- quap(
#  dataGrants,
#  flist = alist(
...
# qsave(m11H04_g, file = a_file)
head(precis(m11H04_g, depth = 2))
```
...
```{r}
a_file <- here::here("fits", "m11H04_d.qs")
m11H04_d <- qread(file = a_file)
# m11H04_d <- quap(
#   dataGrants,
#   flist = alist(
#     awards ~ dbinom(applications, p),
...
```{r}
a_file <- here::here("fits", "m11H04_gd.qs")
m11H04_gd <- qread(file = a_file)
# m11H04_gd <- quap(
#   dataGrants,
#   flist = alist(
#     awards ~ dbinom(applications, p),
...
```{r}
a_file <- here::here("fits", "b11H04_g.qs")
b11H04_g <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "b11H04_d.qs")
b11H04_d <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "b11H04_gd.qs")
b11H04_gd <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "i11H04_g.qs")
i11H04_g <- qread(file = a_file)
...
#                 control.predictor = list(link = 1, compute = TRUE),
#                 control.compute = list(dic = TRUE, cpo = TRUE, waic = TRUE))
# qsave(i11H04_g, file = a_file)
summary(i11H04_g)
```


```{r}
a_file <- here::here("fits", "i11H04_d.qs")
i11H04_d <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "i11H04_gd.qs")
i11H04_gd <- qread(file = a_file)
...
```{r}
a_file <- here::here("fits", "b11H06a.qs")
b11H06a <- qread(a_file)
...
```{r}
a_file <- here::here("fits", "b11H06b.qs")
b11H06b <- qread(a_file)
...
```{r}
a_file <- here::here("fits", "b11H06c.qs")
b11H06c <- qread(a_file)
