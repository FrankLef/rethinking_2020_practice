...
sample$data <- sample$data %>%
  mutate(Y = rnorm(n = nrow(.), mean = 1 + 2 * Z, sd = 5))
GGally::ggpairs(sample$data)
```
...
```{r}
message("TODO: Do it with simsstudy and compare results")
```
