...
ggplot(pred, aes(x = pred)) +
  stat_halfeye(point_interval = ggdist::mean_hdi, .width = 0.89, fill = "palegreen") +
  geom_density(data = dist_binom, mapping = aes(x, y = ..scaled..), color = "violetred", linetype = "dashed") +
  ...
  theme_minimal() +
  labs(title = "Practice 3H3", x = "nb of boys", y = "probability")
```
