...
### Linear predictors: `linpred_marg_draws_inla`
...
### Fitted predictors: `epred_marg_draws_inla`
...
### Posterior predictions: `linpred_draws_inla`
...
This process is done by the `eflINLA::linpred_draws_inla` function.

See section 3.3 in @wang2018.
...
```{r}
preds <- linpred_draws_inla(i04M07ctr, n = 100)
preds
```
