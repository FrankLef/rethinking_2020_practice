...
```{r}
message("This fit is invalid.  Gender should be a factor.  
        See b12H05a below. TO DELETE later.")
...
#                    cores = detectCores(),
#                    seed = 12)
# # message("This takes at least 2 minutes")
...
```{r}
message("This is the same as b12H05 but with gender as a factor.
        It takes 1.5 hr to run.")
a_file <- here::here("fits", "b12H05a.rds")
b12H05a <- readRDS(file = a_file)
...
# beepr::beep("fanfare")
# saveRDS(object = b12H05a, file = a_file)
summary(b12H05a)
```
...
```{r}
a_file <- here::here("fits", "b12H06a.rds")
b12H06a <- readRDS(file = a_file)
...
#       cores = detectCores(),
#       seed = 12)
# saveRDS(object = b12H06a, file = a_file)
```
...
```{r}
a_file <- here::here("fits", "b12H06b.rds")
b12H06b <- readRDS(file = a_file)
...
#       cores = detectCores(),
#       seed = 12)
# saveRDS(object = b12H06b, file = a_file)
summary(b12H06b)
```
